   ...
   return (
      <>
         ...
         <Modal size="lg" show={showModal} onHide={() => setShowModal(false)} aria-labelledby="signup-modal">
            {/* tab container to do either create account or login component */}
               ...
               <Modal.Body>
                  <Tab.Content>
                     <Tab.Pane eventKey="login">
                        <LoginForm handleModalClose={() => setShowModal(false)} route={authRoute} />
                     </Tab.Pane>
                     <Tab.Pane eventKey="signup">
                        <SignUpForm handleModalClose={() => setShowModal(false)} route={authRoute} />
                     </Tab.Pane>
                  </Tab.Content>
               </Modal.Body>
            </Tab.Container>
